...
class Trainer:
    ...
    def _save_checkpoint(self, epoch):
        ...
        PATH = "checkpoint.pt"
        torch.save(ckp, PATH)
        print(f"Epoch {epoch} | Training checkpoint saved to {PATH}")
...
def prepare_dataloader(data_set: Dataset, batch_size: int):
    return DataLoader(data_set, batch_size=batch_size, pin_memory=True, shuffle=True)
